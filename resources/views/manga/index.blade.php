...
@section('title', "Browse Manga — Page {$page} — MangAlfa")

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 py-6 animate-fade-in">
    <div class="flex items-center justify-between mb-6">
        <h1 class="font-display font-700 text-2xl text-white">Browse Manga</h1>
    ...
    <div class="flex items-center justify-center gap-2">
        @if($page > 1)
        <a href="{{ route('manga.index', ['page' => $page - 1, 'per_page' => ($perPage ?? 24)]) }}" class="px-4 py-2 bg-dark-800 hover:bg-dark-700 border border-dark-600 hover:border-accent/40 rounded-xl text-sm text-slate-300 hover:text-white transition-all flex items-center gap-2">
